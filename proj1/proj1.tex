...
\usepackage[left=18mm,top=18mm,text={180mm,250mm}]{geometry}
...
\usepackage[colorlinks=true, bookmarks=true, linkcolor=black, urlcolor=black, unicode]{hyperref}


\title{Typografie a publikování\,--\,1. projekt}
\author{Radoslav Páleník\\\href{mailto:xpalen05@stud.fit.vutbr.cz}{xpalen05@stud.fit.vutbr.cz}}
\date{}
...
Zvýraznění barvou, podtržením, ani změnou písma se\quad  v~odstavcích nepoužívá.
...
Pro systematické doplnění vlnek slouží volně šiřitelný program \emph{vlna} od pana Olšáka\footnote{Viz \tt \href{http://petr.olsak.net/ftp/olsak/vlna/ }{\textbf http://petr.olsak.net/ftp/olsak/vlna/ }}.
